    ...
    days: [
        {
            ...
            meals: [
                { type: "Breakfast", options: [
                    { id: "m_b_1", text: "Vegetable Poha (80g) + 3 whole eggs + 2 egg whites", recipe: "Vegetable Poha", groceries: [{item:"Poha",qty:80,unit:"g"},{item:"Eggs",qty:5,unit:"pcs"}] },
                    { id: "m_b_2", text: "Paneer Besan Chilla (3) + Mint chutney", recipe: "Paneer Besan Chilla", groceries: [{item:"Besan",qty:100,unit:"g"},{item:"Low-fat Paneer",qty:120,unit:"g"},{item:"Mint",qty:1,unit:"bunch"}] }
                ]},
                { type: "Morning Snack", options: [
                    { id: "m_ms_1", text: "200g Greek yogurt + 1 apple + 10 almonds", recipe: null, groceries: [{item:"Greek Yogurt",qty:200,unit:"g"},{item:"Apples",qty:1,unit:"pc"},{item:"Almonds",qty:10,unit:"pcs"}] },
                    { id: "m_ms_2", text: "Paneer (100g) + 1 orange", recipe: null, groceries: [{item:"Low-fat Paneer",qty:100,unit:"g"},{item:"Oranges",qty:1,unit:"pc"}] }
                ]},
                { type: "Lunch", options: [
                    { id: "m_l_1", text: "Healthy Chicken Kadai (220g) + 150g basmati rice + Salad", recipe: "Healthy Chicken Kadai", groceries: [{item:"Chicken Breast",qty:220,unit:"g"},{item:"Basmati Rice",qty:150,unit:"g"},{item:"Salad Veggies",qty:1,unit:"serving"}] },
                    { id: "m_l_2", text: "Oven Baked Chicken (220g) + 2 whole wheat rotis + Mixed vegetables", recipe: "Oven Baked Chicken", groceries: [{item:"Chicken Breast",qty:220,unit:"g"},{item:"Whole Wheat Atta",qty:2,unit:"rotis"},{item:"Mixed Vegetables",qty:1,unit:"serving"}] }
                ]},
                { type: "Pre-Workout", options: [
                    { id: "m_pw_1", text: "1 banana + Black coffee", recipe: null, groceries: [{item:"Bananas",qty:1,unit:"pc"},{item:"Coffee",qty:1,unit:"serving"}] },
                    { id: "m_pw_2", text: "2 dates + Black coffee", recipe: null, groceries: [{item:"Dates",qty:2,unit:"pcs"},{item:"Coffee",qty:1,unit:"serving"}] }
                ]},
                { type: "Dinner (Post Workout)", options: [
                    { id: "m_d_1", text: "Garlic Lemon Baked Chicken (250g) + Roasted vegetables + 1 roti", recipe: "Garlic Lemon Baked Chicken", groceries: [{item:"Chicken Breast",qty:250,unit:"g"},{item:"Mixed Vegetables",qty:1,unit:"serving"},{item:"Whole Wheat Atta",qty:1,unit:"roti"}] },
                    { id: "m_d_2", text: "Chicken Curry (220g) + 150g rice + Cucumber salad", recipe: "Chicken Curry", groceries: [{item:"Chicken Breast",qty:220,unit:"g"},{item:"Basmati Rice",qty:150,unit:"g"},{item:"Cucumbers",qty:1,unit:"serving"}] }
                ]},
